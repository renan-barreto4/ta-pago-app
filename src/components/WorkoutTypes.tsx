        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <Card className="relative z-10 w-full max-w-lg max-h-[90vh] overflow-y-auto bg-card shadow-modal animate-scale-in">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
              <CardTitle className="text-lg font-semibold text-foreground">Editar Treino</CardTitle>
                ...
                <div className="flex gap-4">
                  <div className="flex-1 space-y-2">
                    ...
                    <Popover open={showEmojiPicker} onOpenChange={setShowEmojiPicker}>
                      ...
                      <PopoverContent className="w-80 p-4 z-[9999]" align="center">
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    <Popover open={showColorPicker} onOpenChange={setShowColorPicker}>
                      ...
                      <PopoverContent className="w-64 p-4 z-[9999]" align="center">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3 max-h-60 overflow-y-auto">
                    ...
                    {formData.exercises.length === 0 && (
                      <div className="text-center py-4 text-muted-foreground text-sm">Nenhum exercício adicionado</div>
                    )}
                  </div>
                </div>
        ...
        {workoutTypes.length === 0 ? (
          <Card className="p-12 text-center">
            <div className="flex flex-col items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-2">Carregando tipos de treino...</h3>
                <p className="text-muted-foreground">Aguarde enquanto carregamos os tipos de treino disponíveis</p>
              </div>
            </div>
          </Card>
        ) : (
